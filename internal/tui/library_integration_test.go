...
func TestIntegration_SearchFiltering(t *testing.T) {
	...
	models := []state.ModelMetadata{
		...
		{
			DownloadURL: "https://huggingface.co/model2.gguf",
		...
		{
			DownloadURL: "https://huggingface.co/model3.gguf",
		...
		{
			DownloadURL: "https://civitai.com/lora1.safetensors",
		...
		{
			DownloadURL: "https://civitai.com/lora2.safetensors",
...
func TestIntegration_FavoriteManagement(t *testing.T) {
	...
	models := []state.ModelMetadata{
		{
			DownloadURL: "https://example.com/fav.gguf",
		...
		{
			DownloadURL: "https://example.com/normal.gguf",
